class ClearcartOptions < ActiveRecord::Base
  ...
  def self.defaults
    default_hash = {
        ...
        initial_cart_abandonment_message: 'The {ITEM} in your cart is now {DISCOUNT} off. Text PAY to buy it now!',
        follow_up_message: '{ITEM} is still {DISCOUNT} off and is still in your cart. Reply with PAY to buy it now!',
